...
<script>
import ListCommponents from "@/components/ListCommponents.vue";
...
.Twoline > div:first-child {
  margin-left: 10px;
}
.Twoline > div:last-child {
  font-size: 12px;
  margin-right: 10px;
}
.fa {
...
.Oneline > div:first-child {
  font-size: 18px;
  margin-left: 10px;
  font-weight: bolder;
}
.Oneline > div:last-child {
  line-height: 20px;
  font-size: 12px;
  width: 80px;
  height: 20px;
